        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group p-6 rounded-3xl bg-gradient-to-br from-neutral-900 to-[hsl(var(--background))] border border-foreground/5 hover:border-foreground/20 transition-all duration-300"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group p-6 rounded-3xl bg-gradient-to-br from-cyan-950/20 to-[hsl(var(--background))] border border-foreground/5 hover:border-cyan-500/30 transition-all duration-300"
            >
              <div className="flex justify-between items-start mb-6">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group sm:col-span-2 p-6 rounded-3xl bg-gradient-to-r from-purple-900/10 to-[hsl(var(--background))] border border-foreground/5 hover:border-purple-500/30 transition-all duration-300"
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <ArrowUpRight className="w-5 h-5 text-muted-foreground group-hover:text-purple-400 transition-colors" />
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <ArrowUpRight className="w-5 h-5 text-muted-foreground group-hover:text-pink-400 transition-colors" />
                </div>
