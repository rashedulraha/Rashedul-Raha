      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="md:hidden fixed inset-0 z-30 pt-16 bg-background/95 backdrop-blur-3xl overflow-y-auto"
          >
              ...
              {[
                ...
                <button
                  ...
                  className={`p-4 rounded-xl text-left capitalize font-medium ${
                    activeTab === tab ? "bg-primary/10 text-primary font-bold" : "text-muted-foreground"
                  }`}
                >
                  {tab.replace("-", " ")}
                </button>
