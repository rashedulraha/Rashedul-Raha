...
const techDetails = {
  frontend: {
    ...
    tools: [
      { name: "Next.js 14", desc: "React framework with SSR & SSG" },
  ...
  devops: {
    ...
    tools: [
      ...
      { name: "Linux", desc: "Development environment" },
    ],
  },
  os: {
    ...
    tools: [
      { name: "macOS", desc: "Primary development OS" },
      { name: "Linux (Ubuntu)", desc: "Server & development" },
      { name: "Windows", desc: "For testing & compatibility" },
    ],
  },
};
