...
export default function Testimonials() {
  ...
  return (
    <section className="py-16 lg:py-20  relative overflow-hidden" id="testimonials">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg text-white/60 leading-relaxed">
            Here’s what founders, marketers, and creative directors have to say about working together.
          </p>
        </div>
                ...
                <footer className="mt-auto flex items-center gap-4 relative z-10 pt-6 border-t border-white/5">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-1 -right-1 size-4 bg-green-500 rounded-full border-2 border-[#0a0a0a] flex items-center justify-center">
                       <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" className="text-white"><polyline points="20 6 9 17 4 12"></polyline></svg>
                    </div>
                  </div>
        ...
        <div className="flex items-center justify-center gap-4 mt-10 px-4">
          ...
          >
            {isPaused ? (
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="opacity-90 ml-0.5">
                <path d="M5 3l14 9-14 9V3z" />
              </svg>
            ) : (
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="opacity-90">
