                  ...
                  >
                    ...
                    <div className="bg-card border border-border rounded-xl flex flex-col mb-4 overflow-hidden focus-within:ring-1 focus-within:ring-primary/20 transition-shadow">
                      <div className="p-4 border-b border-border flex items-center gap-3 bg-muted/30">
                        <div className="h-8 w-8 rounded-full overflow-hidden bg-accent border border-border">
                          <Image src="https://i.pravatar.cc/100?img=4" alt="Rashedul" width={32} height={32} className="w-full h-full object-cover" />
                        </div>
                        <div className="flex flex-col">
                          <span className="text-sm font-medium text-primary leading-none">Send Rashedul a message</span>
                          <span className="text-xs text-muted-foreground mt-1">I read every one</span>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      ...
                      >
                        ...
                        <span className="text-sm font-medium text-primary mb-1 group-hover:text-primary transition-colors">Book a call</span>
                        <span className="text-xs text-muted-foreground">30 min • no strings</span>
                      </button>

                      {/* Email me */}
                      <button
                        onClick={() => runCommand(() => window.location.href = "mailto:hello@rashedul.com")}
                        className="flex flex-col items-start p-4 bg-card border border-border rounded-xl hover:bg-white/5 transition-colors group text-left"
                      >
                        ...
                        <span className="text-sm font-medium text-primary mb-1 group-hover:text-primary transition-colors">Email me</span>
                        <span className="text-xs text-muted-foreground">hello@rashedul.com</span>
                      </button>
                    </div>
                    ...
                    <div className="mt-auto pt-4 grid grid-cols-3 gap-2">
                      <button
                        onClick={() => runCommand(() => window.open("https://linkedin.com", "_blank"))}
                      ...
                      <button
                        onClick={() => runCommand(() => window.open("https://twitter.com", "_blank"))}
                        className="flex items-center justify-center gap-2 py-2 px-3 bg-muted/50 hover:bg-accent rounded-full text-xs font-medium text-muted-foreground hover:text-primary transition-colors border border-border/50"
                      >
                      ...
                      <button
                        onClick={() => runCommand(() => window.open("https://github.com", "_blank"))}
                        className="flex items-center justify-center gap-2 py-2 px-3 bg-muted/50 hover:bg-accent rounded-full text-xs font-medium text-muted-foreground hover:text-primary transition-colors border border-border/50"
                      >
                ...
                {currentView === "full-form" && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h2 className="font-medium text-primary">Send a Message</h2>
                    </div>

                    {/* Form Layout */}
                    <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); runCommand(() => { setMessage(''); }); }}>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5">
                          <label className="text-xs font-medium text-muted-foreground">Name</label>
                          <input type="text" placeholder="John Doe" className="bg-white/5 border border-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-white/20 transition-all" />
                        </div>
                        <div className="flex flex-col gap-1.5">
                          <label className="text-xs font-medium text-muted-foreground">Email</label>
                          <input type="email" placeholder="john@example.com" className="bg-white/5 border border-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-white/20 transition-all" />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5">
                          ...
                          <input type="tel" placeholder="+1 (555) 000-0000" className="bg-white/5 border border-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-white/20 transition-all" />
                        </div>
                        <div className="flex flex-col gap-1.5">
                          <label className="text-xs font-medium text-muted-foreground">Topic</label>
                          <input type="text" placeholder="Project Inquiry" className="bg-white/5 border border-border rounded-md px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-white/20 transition-all" />
                        </div>
                      </div>
                      ...
                      <div className="flex justify-end mt-2">
                        <button type="submit" className="bg-white text-black px-4 py-2 rounded-md font-medium text-sm hover:bg-gray-200 transition-colors">
                          Send Message
                        </button>
                      </div>
                    </form>
